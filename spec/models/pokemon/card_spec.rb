...
RSpec.describe Pokemon::Card, type: :model do
  describe 'class methods' do
    describe '.ability_names' do
      ...
      it { is_expected.to contain_exactly("Cursed Land",
                                          "Voraciousness",
    ...
    describe '.attack_names' do
      ...
      it { is_expected.to contain_exactly("Grasping Draw",
                                          "Hypnosis",
                                          "Stompy Stomp",
                                          "Razor Leaf",
                                          "Wild Charge",
    ...
    describe '.subtypes' do
      ...
      it { is_expected.to contain_exactly("Ancient",
                                          "Basic",
                                          "ex",
                                          "Future",
                                          "Item",
    ...
    describe '.types' do
      ...
      it { is_expected.to contain_exactly("Colorless",
                                          "Darkness",
                                          "Dragon",
                                          "Fighting",
                                          "Fire",

...
ActiveRecord::Schema[7.1].define(version: 20_240_224_011_027) do
  ...
  create_table 'deckshare_pokemon_cards', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.index %w[user_id card_id], name: 'index_deckshare_pokemon_cards_on_user_id_and_card_id', unique: true
